...
public class Utils {
    ...
    public static boolean isColliding(GameObject gameObject1, GameObject gameObject2) {
        return
            !(gameObject2.pos[0] + gameObject2.width > gameObject1.pos[0] &&
    ...
    public static boolean isCollidingWithVelocity(GameObject gameObject1, GameObject gameObject2) {
        /*if (gameObject1.pos[0] > gameObject2.pos[0] + gameObject2.width || gameObject1.pos[0] < gameObject2.pos[0]) {
            return false;
        }

        if (gameObject1.pos[1] > gameObject2.pos[1] + gameObject2.height || gameObject1.pos[1] < gameObject2.pos[1]) {
            return false;
        }
